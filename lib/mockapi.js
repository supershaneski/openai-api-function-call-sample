...
function getEvents({ location, date }) {
    ...
    const events = ['Outdoor Fiesta', 'Sumo Exhibition', 'Earth Day', 'Ramen Festival', 'Jazz Festival']
...
function getEvent({ location, date, event }) {
    ...
    const places = ['Yamada Hall', 'Community Center', 'City Park', 'River Park', 'United Stadium', 'Sports Center']
    ...
    // API is not processing image in the way I want it in dev mode
